...
class Patientinformationer extends StatelessWidget {
  ...
  List<MenuListTile> menuItems = [
    MenuListTile(text: 'Hvad gør du, hvis du kommer til skade?', icon: Icons.back_hand_outlined),
    MenuListTile(text: 'Gynækologisk akutambulatorie', icon: Icons.pregnant_woman_outlined),
    MenuListTile(text: 'Modtagelse/Medicinsk skadestue', icon: Icons.local_hotel_outlined),
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                leading: Icon(menuItems[index].icon, color: Constants.kWhiteColor, size: 30),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
